...
export default function MobileNav({ isAdmin, hasUnread, isUser, userId }: Props) {
          ...
          <nav className="px-6 py-2" aria-label="Mobile navigation">
            ...
            {isAdmin && (
              <>
                ...
                <Link href="/dashboard/post-inspection" className={NAV_LINK} onClick={() => setOpen(false)}>
                  Post-Inspection
                </Link>
                <Link href="/dashboard/reports" className={NAV_LINK} onClick={() => setOpen(false)}>
                  Reports
                </Link>
                <Link href="/dashboard/governance" className={NAV_LINK} onClick={() => setOpen(false)}>
                  Governance
                </Link>
              </>
            )}
            ...
            <Link href="/dashboard/feedback" className={NAV_LINK} onClick={() => setOpen(false)}>
              Feedback
            </Link>
