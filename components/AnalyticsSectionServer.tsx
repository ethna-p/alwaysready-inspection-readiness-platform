 ...
 *
 * Fetches the heavier analytics data and renders all analytics cards.
 ...
 *
 * Pure chart components and shared helpers live in ./analytics/AnalyticsCharts.tsx.
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-2 antialiased">Overall readiness — 6-month view</h3>
              <TrendChart points={trendPoints} />
            </div>

            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">KLOE ownership</h3>
              <CompletionBar
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">KLOE evidence coverage</h3>
              <CompletionBar
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">KLOE action plan coverage</h3>
              <CompletionBar
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">KLOE action plan health</h3>
              {actions.length === 0 ? (
                <div>
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">KLOE review calendar</h3>
              <ReviewCalendarChart overdue={reviewOverdue} due30={reviewDue30} due60={reviewDue60} due90={reviewDue90} />
            </div>

            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">People&apos;s Voice coverage</h3>
              <CompletionBar
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">People&apos;s Voice action plan coverage</h3>
              {pvTotal === 0 ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">Mock inspection ratings</h3>
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">Mock inspection — action plan coverage</h3>
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">Return-to-work interviews</h3>
              {rtwTotal === 0 ? (
                <div>
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">Absence reasons</h3>
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">Bradford Factor — team overview</h3>
            ...
            <div className="bg-card rounded-2xl border border-line p-5">
              <h3 className="text-xs font-bold text-brand uppercase tracking-wide mb-3 antialiased">HR compliance</h3>
              {hrTotal === 0 ? (
                <div>
                  <div className="opacity-30 select-none" aria-hidden="true">
