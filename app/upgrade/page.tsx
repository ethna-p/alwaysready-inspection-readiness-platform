              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 text-sm text-ink">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Role-based access — Admin, User, and Visitor',
                    'Team management — add team members, assign KLOEs, reset passwords',
