-- ─────────────────────────────────────────────────────────────────────────────
-- Migration: 20260724000009_specialist_college_checklist_cqc_language
-- Purpose : Replace all 28 Specialist College Core checklist items with
--           the CQC's exact Good-level characteristic language from the
--           Adult Social Care Assessment Framework (Draft v9).
--           Delete 14 DEM- prefixed dementia sub-service items.
--           Insert 71 gap items for CQC Good-level KLOEs not previously
--           covered.
-- Rule    : Every checklist_item is a direct verbatim quote from CQC Good
--           characteristics. No paraphrasing. No service-type modifications.
-- ─────────────────────────────────────────────────────────────────────────────

-- ═══════════════════════════════════════════════════════════════════════════
-- SECTION 1: DELETE DEM- prefixed dementia sub-service items
-- ═══════════════════════════════════════════════════════════════════════════

DELETE FROM public.klo_checklist_items
WHERE ref LIKE $$DEM-%$$
  AND service_type_id = (SELECT id FROM public.service_types WHERE name = $$Specialist College$$);

-- ═══════════════════════════════════════════════════════════════════════════
-- SECTION 2: UPDATE existing Core items with exact CQC Good-level text
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ── SAFE ▸ Staffing (recruitment and levels) ────────────────────────────────
...
-- ═══════════════════════════════════════════════════════════════════════════
-- SECTION 3: INSERT gap items for CQC Good-level KLOEs not previously covered
-- ═══════════════════════════════════════════════════════════════════════════

-- ── GAP: SAFE ▸ Safety culture (SAF-SC-01 to SAF-SC-06) ─────────────────────
...
-- ── GAP: SAFE ▸ Managing risks — missing characteristics ─────────────────────
...
-- ── GAP: SAFE ▸ Safe systems, pathways and transitions ──────────────────────
-- SAF-SP-01 and SAF-SP-02 are covered by existing RES-TR-01 and RES-TR-02
...
-- ── GAP: SAFE ▸ Safeguarding — people empowered to raise concerns ─────────────
...
-- ── GAP: SAFE ▸ Safe environments and infection prevention and control ────────
...
-- ── GAP: SAFE ▸ Safe medicines and treatments — missing characteristics ───────
-- SAF-MM-01 covers SAF-MT-01 text
...
-- ── GAP: EFFECTIVE ▸ Assessing needs — people involved in assessment ──────────
-- EFF-CP-01 covers EFF-AN-01, EFF-CP-02 covers EFF-AN-03, EFF-EH-01 covers EFF-AN-02
...
-- ── GAP: EFFECTIVE ▸ Evidence-based care and equitable outcomes ───────────────
...
-- ── GAP: EFFECTIVE ▸ Supporting people to live healthier lives ───────────────
-- EFF-HL-01 and EFF-HL-02 are covered by existing items
...
-- ── GAP: EFFECTIVE ▸ Consent to care and treatment ───────────────────────────
-- EFF-CT-01 and EFF-CT-02 are covered by existing items
...
-- ── GAP: CARING ▸ Kindness, compassion and dignity ───────────────────────────
...
-- ── GAP: CARING ▸ Person-centred care ────────────────────────────────────────
...
-- ── GAP: CARING ▸ Independence, choice and control — missing characteristics ──
-- CAR-IC-01 and CAR-IC-02 are covered by existing items
...
-- ── GAP: RESPONSIVE ▸ Care provision, integration and continuity ──────────────
-- RES-RC-01 covers RES-CC-01 text
...
-- ── GAP: RESPONSIVE ▸ Listening to and responding to feedback ────────────────
-- RES-CF-01 covers RES-LF-01 text
...
-- ── GAP: RESPONSIVE ▸ Timely and equitable access ────────────────────────────
...
-- ── GAP: RESPONSIVE ▸ Equity in experiences ──────────────────────────────────
...
-- ── GAP: WELL-LED ▸ Strategic direction ──────────────────────────────────────
...
-- ── GAP: WELL-LED ▸ Workforce equity and culture ─────────────────────────────
...
-- ── GAP: WELL-LED ▸ Capable and compassionate leaders ────────────────────────
...
-- ── GAP: WELL-LED ▸ Governance and management — missing characteristics ───────
-- WEL-GM-01, WEL-GM-02, WEL-GM-03 are covered by existing items
...
-- ── GAP: WELL-LED ▸ Partnerships and communities ─────────────────────────────
...
-- ── GAP: WELL-LED ▸ Improvement, innovation and learning ─────────────────────
